...
<body lang="en">
  <div class="card-wrapper card-1">
    <div id="signin-wrapper" class="card">
      ...
      <input id="user-email" type="text" name="input-fields" placeholder="ユーザ名">
      <input id="user-pass" type="password" name="input-fields" placeholder="パスワード">

      <div id="log-in" class="confirm-button btn">
      ...
      <span id="forgot-password" class="btn">ログインを忘れました?</span>
    </div>
    <div class="card">
